  ...
  <body>
    ...
    <div class="body-box">      
      <div class="functional-interface">
        ...
        <ChartComponent :dataForChartBuilding="childObject" @sendingData="currencyShortNameFromComponent"
...
export default {
  ...
  methods: {
    ...
    currencySelectOnHand() {
      ...
      //const optionVisible=this.$refs.shortOptionOnHand
      //optionVisible.style.display = 'none'      
    },
